...
public class ReportTest {
	...
	public void setup() {
		...
		terminal  = new Terminal("terminalAbasto","asd", new Coordinate(53.54,12.54),null,"TERMINAL");
		terminal2 =new Terminal("terminalPalermo","asd", new Coordinate(54.14,45.54),null,"TERMINAL");
